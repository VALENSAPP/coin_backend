...
__decorate([
    ...
    (0, class_validator_1.IsString)(),
    __metadata("design:type", String)
], GetAllUsersDto.prototype, "email", void 0);
__decorate([
    (0, swagger_2.ApiProperty)({
    ...
    (0, class_validator_1.IsString)(),
    __metadata("design:type", String)
], GetAllUsersDto.prototype, "userName", void 0);
__decorate([
    (0, swagger_2.ApiProperty)({
    ...
    (0, class_validator_1.IsString)(),
    __metadata("design:type", String)
], GetAllUsersDto.prototype, "googleId", void 0);
__decorate([
    (0, swagger_2.ApiProperty)({
    ...
    (0, class_validator_1.IsString)(),
    __metadata("design:type", String)
], GetAllUsersDto.prototype, "twitterId", void 0);
__decorate([
    (0, swagger_2.ApiProperty)({
...
let UserController = class UserController {
    ...
    async getRecentActivities(req, query) {
        const userId = req.user.userId;
...
__decorate([
    ...
    (0, common_1.UseGuards)((0, passport_1.AuthGuard)('jwt')),
    (0, swagger_1.ApiBearerAuth)(),
    (0, swagger_3.ApiOperation)({ summary: 'Change password for authenticated user' }),
    __param(0, (0, common_1.Req)()),
    __param(1, (0, common_1.Body)()),
    __metadata("design:type", Function),
...
__decorate([
    ...
    (0, common_1.UseGuards)((0, passport_1.AuthGuard)('jwt')),
    (0, swagger_1.ApiBearerAuth)(),
    (0, swagger_3.ApiOperation)({ summary: 'Get all users (excluding soft-deleted) with optional search filters' }),
    (0, swagger_3.ApiQuery)({ name: 'email', type: String, required: false, description: 'Search by email' }),
    (0, swagger_3.ApiQuery)({ name: 'userName', type: String, required: false, description: 'Search by userName' }),
    (0, swagger_3.ApiQuery)({ name: 'googleId', type: String, required: false, description: 'Search by googleId' }),
    (0, swagger_3.ApiQuery)({ name: 'twitterId', type: String, required: false, description: 'Search by twitterId' }),
    (0, swagger_3.ApiQuery)({ name: 'phoneNumber', type: String, required: false, description: 'Search by phoneNumber' }),
    __param(0, (0, common_1.Query)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [GetAllUsersDto]),
    __metadata("design:returntype", Promise)
...
__decorate([
    ...
    (0, common_1.UseGuards)((0, passport_1.AuthGuard)('jwt')),
    (0, swagger_1.ApiBearerAuth)(),
    (0, swagger_3.ApiOperation)({ summary: 'Get recent activities for the authenticated user' }),
    (0, swagger_3.ApiQuery)({ name: 'type', type: String, required: false, description: 'Filter by activity type: purchase, sell, following' }),
    __param(0, (0, common_1.Req)()),
    __param(1, (0, common_1.Query)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Object, recent_activities_dto_1.RecentActivitiesDto]),
    __metadata("design:returntype", Promise)
], UserController.prototype, "getRecentActivities", null);
__decorate([
    (0, common_1.Get)('suggested-users'),
    (0, common_1.UseGuards)((0, passport_1.AuthGuard)('jwt')),
    (0, swagger_1.ApiBearerAuth)(),
    (0, swagger_3.ApiOperation)({ summary: 'Get suggested users based on common followers and following' }),
    (0, swagger_3.ApiQuery)({ name: 'limit', type: Number, required: false, description: 'Number of suggested users to return (default: 10)' }),
    __param(0, (0, common_1.Req)()),
    __param(1, (0, common_1.Query)('limit')),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Object, String]),
    __metadata("design:returntype", Promise)
], UserController.prototype, "getSuggestedUsers", null);
__decorate([
